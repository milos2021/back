...
import pandas as pd
empdata = pd.read_csv('reporting/StatisticUserReport_prematch_6_meseci.csv', index_col=False, delimiter = ',', header=None)
...
for i,row in empdata.iterrows():
	...
	if i > 49581:
		sql = "INSERT INTO StatisticUserReportDefault VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,1,0)"
